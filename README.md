# AutoML Experimentation Pipeline
...
Systematically searching over models, preprocessing, and hyperparameters requires a reusable experimentation framework with tracking.
...
1. Phase 1: Search space definitions for preprocessing/models
2. Phase 2: Optuna-based hyperparameter optimization loop
3. Phase 3: MLflow experiment tracking integration
4. Phase 4: Leaderboard UI
...
cd automl-experiment-framework
...
```bash
docker build -t automl-experiment-framework .
docker run -p 8000:8000 automl-experiment-framework
```
